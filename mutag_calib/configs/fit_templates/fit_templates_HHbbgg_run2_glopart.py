...
Usage (run separately per year, changing the year filter below):
  pocket-coffea run --cfg mutag_calib/configs/fit_templates/fit_templates_HHbbgg_run2_glopart.py \\
    -o fit_templates_HHbbgg_2018_glopart -e dask@lxplus \\
...
# ============================================================================
# YEAR SELECTION: Change this to run for different Run 2 years
# Options: "2018", "2017", "2016_PostVFP", "2016_PreVFP"
# ============================================================================
YEAR = "2018"

# Year-specific binning and WPs
pt_binning = parameters["mutag_calibration"]["pt_binning"][YEAR]
wp_dict = parameters["mutag_calibration"]["wp"][YEAR]
msd_binning = parameters["mutag_calibration"]["msd_binning"][YEAR]
